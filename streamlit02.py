...
class Database:
    ...
    st.markdown( "<h1 class='main-title'>🏥 Rehabilitation Management System</h1>", unsafe_allow_html=True ) st.markdown( "<p class='subtitle'>Addiction Recovery & Therapy Management Dashboard</p>", unsafe_allow_html=True ) 
    st.divider() 
